...
const successIcon = (
  <div className="mr-[6px] inline-flex size-[20px] shrink-0 items-center justify-center rounded-[4px] bg-green-100 text-green-500">
    <svg
      aria-hidden="true"
      className="size-[16px]"
      fill="currentColor"
...
const errorIcon = (
  <div className="mr-[6px] inline-flex size-[20px] shrink-0 items-center justify-center rounded-[4px] bg-red-100 text-red-500">
    <svg
      aria-hidden="true"
      className="size-[16px]"
      fill="currentColor"
...
const warningIcon = (
  <div className="mr-[6px] inline-flex size-[20px] shrink-0 items-center justify-center rounded-[4px] bg-orange-100 text-orange-500">
    <svg
      aria-hidden="true"
      className="size-[16px]"
      fill="currentColor"
